...
const Usuario = ({usua, setModal,setIdEliminar,setEditUsua,setUsuario,setTiposUsu,setEliminarUsu }) => {
...
return (
    ...
    <div className='flex p-1 space-x-3'>
        <button className='bg-emerald-600 p-1 text-white font-bold rounded-md
        hover:bg-emerald-700 transition-colors'
        onClick={handleEditar}
        >Editar</button>
        <button className='bg-red-600 p-1 text-white font-bold rounded-md 
